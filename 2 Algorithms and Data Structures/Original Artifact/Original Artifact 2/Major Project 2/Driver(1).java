...
public class Driver {
    ...
    public static void main(String[] args) {
        ...
        // Create while loop statement to display the menu.
        initializeDogList();
        initializeMonkeyList();
        String quit = "n";

        // Create while loop statement to go through all menu options.
        // Set the loop to quit when user enters q. Ignore case allows user to enter q or Q
        while (!quit.equalsIgnoreCase("q")) {
            displayMenu();
            Scanner scanner = new Scanner(System.in);
            String input = scanner.nextLine();

            // First if statement when user enters menu 1.   Start of loop statements.
            if (input.equalsIgnoreCase("1")) {
                intakeNewDog(scanner);
            }

            else if (input.equalsIgnoreCase("2")) { // 2nd choice statement.
                intakeNewMonkey(scanner);
            }

            else if (input.equalsIgnoreCase("3")) { // 3rd choice statement.
                reserveAnimal(scanner);
            }

            else if (input.equalsIgnoreCase("4")) { // 4th choice statement.
                printAnimals("dog");
            }

            else if (input.equalsIgnoreCase("5")) { // 5th choice statement.
                printAnimals("monkey");
            }

            else if (input.equalsIgnoreCase("6")) { // 6th choice statement.
                printAnimals("available");
            }

            else if (input.equalsIgnoreCase("q")) { // Allows user to quit loop.
                quit = input;
            }

            else {
                System.out.println("User input is invalid, please use an option from the menu.");
            }
    ...
    public static void initializeMonkeyList() {
        ...
        Monkey monkey2 = new Monkey("Jimmy","Male","5", "89", "Mandrill", "2.8", "1.5", "3.1", "12-10-2022", "United States", "intake", true, "United states");
    ...
    public static void intakeNewDog(Scanner scanner) {
        ...
        System.out.println("Gender of Dog (Male/Female): ");
        ...
        // Create an if else statement for reserving the animal.
        System.out.println("Reserved (1 for true, 0 for false): ");
        String choice = scanner.nextLine();
        boolean reserved;
        reserved = choice.equals("1");
    ...
    public static void intakeNewMonkey(Scanner scanner) {
        ...
        // Prompt the user to enter the gender, male or female of the animal.
        System.out.println("Gender of Monkey (Male/Female): ");
        String gender = scanner.nextLine();
        ...
        // Prompt the user to enter the weight of the animal.
        System.out.println("Enter Weight of Monkey: ");
        String weight = scanner.nextLine();

        // Prompt the user to enter the species type of the Monkey.
        System.out.println("Species Type of Monkey: ");
    ...
    public static void reserveAnimal(Scanner scanner) {
        ...
        // Create the else statement if someone request neither a dog nor monkey, inform them of their choices.
        else {
    ...
    public static void printAnimals(String listType) {
        ...
        //printAnimals for dogs that are available for reservation.  Include all dog information if the user selects dog.
